...
namespace StoreDataTable
{
    ...
    { 
        ...
        static string spreadSheetID = "1M9vZFUB29CaW_Re5-Y6HqEpNoPomHRkVLaH_dJP7XZo"; // it is file id
...
#region fuctions
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            string text = reader.ReadData("StoreDataTable"); 
            if (text != null)
            {
