...
namespace InGameLevelDataTable
{
    ...
    { 
        ...
        static string spreadSheetID = "1Eex-qsD4RWC5kg000rFVRRLUTIYhR1qKYaVSJ1hGfyI"; // it is file id
...
/* Fields. */
		...
		public System.Int32 CumulativeExp;
...
#region fuctions
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            string text = reader.ReadData("InGameLevelDataTable"); 
            if (text != null)
            {
