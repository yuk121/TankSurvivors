...
namespace CreatureDataTable
{
    ...
    { 
        ...
        static string spreadSheetID = "139IsgBvWYSq6Th8PZeH7P0jlYzh5M3NbkJlxGnRtYhM"; // it is file id
...
/* Fields. */
		...
		public System.String CretureLocalName;
...
#region fuctions
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            string text = reader.ReadData("CreatureDataTable"); 
            if (text != null)
            {
          ...
          // 실제 데이터 로드
                    if (rows.Count != 0)
                    {
                        ...
                        for (int i = 0; i < rowCount; i++)
                        {
                            ...
                            List.Add(instance); 
                            Map.Add(instance.CreatureId, instance);
                        }
