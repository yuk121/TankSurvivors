...
namespace DropItemDataTable
{
    ...
    { 
        ...
        static string spreadSheetID = "1kuWYejEVqYZ862sMYdr78zTG4hxXJzWcE3GgYYN7AOs"; // it is file id
...
/* Fields. */
		...
		public System.Int32 DropIntemId;
		public System.String DropItemLocalName;
		public System.String DropItemLocalDesc;
...
#region fuctions
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            string text = reader.ReadData("DropItemDataTable"); 
            if (text != null)
            {
          ...
          // 실제 데이터 로드
                    if (rows.Count != 0)
                    {
                        ...
                        for (int i = 0; i < rowCount; i++)
                        {
                            ...
                            List.Add(instance); 
                            Map.Add(instance.DropIntemId, instance);
                        }
