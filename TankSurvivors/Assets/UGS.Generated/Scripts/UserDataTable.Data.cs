...
namespace UserDataTable
{
    ...
    { 
        ...
        static string spreadSheetID = "1bMblYfjCwzklaGxbomiVIM9HrDthW0VFFC7u83JGuBw"; // it is file id
...
/* Fields. */
		...
		public System.Int32 UserCumulativeExp;
...
#region fuctions
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            string text = reader.ReadData("UserDataTable"); 
            if (text != null)
            {
          ...
          // 실제 데이터 로드
                    if (rows.Count != 0)
                    {
                        ...
                        for (int i = 0; i < rowCount; i++)
                        {
                            ...
                            List.Add(instance); 
                            Map.Add(instance.UserLevel, instance);
                        }
