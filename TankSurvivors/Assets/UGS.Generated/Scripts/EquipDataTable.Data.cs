...
namespace EquipDataTable
{
    ...
    { 
        ...
        static string spreadSheetID = "1nm_85Bj1xDnJeJX_IR--XK3FeWz9CiGevOH6g0px55o"; // it is file id
...
#region fuctions
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            string text = reader.ReadData("EquipDataTable"); 
            if (text != null)
            {
